...
public class GooglePlayRatingProvider implements RatingAdapter{
	// ===========================================================
	// Constants
	// ===========================================================

	static final String LOG_TAG = GooglePlayRatingProvider.class.getSimpleName();
	...
	public void RateMyApp(Activity pActivity) {
		Uri uri = Uri.parse("market://details?id=" + pActivity.getPackageName());
		Intent goToMarket = new Intent(Intent.ACTION_VIEW, uri);
		try {
			pActivity.startActivity(goToMarket);
		} catch (ActivityNotFoundException e) {
		    Log.e(LOG_TAG, "Could not launch GooglePlay");
		}
	}
}